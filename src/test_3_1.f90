    ...
    open(IO,FILE='input/tests/input_test_3_1.txt')
    read(IO,*) L
	read(IO,*) H
    read(IO,*) NI, NJ
    read(IO,*) EPS
...
!----------------- Initial fields -----------------------------
    ...
    J=1
    Open(IO,FILE='output/tests/test_3_1/Alpha-X.txt')
    do i=2,NI
    ...
    i=NI
    Open(IO,FILE='output/tests/test_3_1/T-Y.txt')
    do j=1,NJ
    Write(IO,*)  Y_Node(I,J),T_n(I,J)
    enddo
    Close(IO)

    Open(IO,FILE='output/tests/test_3_1/U-Y.txt')
    do j=1,NJ
